        ...
        public void Configure(IConfiguration configuration, IClientBuilder clientBuilder)
        {
            clientBuilder
                .Services.AddSerializer(ser =>
                 {
                     ser.AddNewtonsoftJsonSerializer(isSupported: type => type.Namespace.StartsWith("OnlineMarket.Core.Common") || type.Namespace.StartsWith("OnlineMarket.OrleansImpl"));
                 })
                .AddSingleton(ConfigHelper.NonTransactionalDefaultAppConfig);
